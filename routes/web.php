...
Route::resource('/admin/section3_categories', Section3_categoriesController::class);
Route::resource('/admin/section3_category_images', Section3_category_imagesController::class);
...
Route::get('/admin/change-user', [App\Http\Controllers\HomeController::class, 'changeUser'])->name('change-user');
Route::post('/admin/change-user', [App\Http\Controllers\HomeController::class, 'updateUser'])->name('update-user');

Route::post('send-email', [App\Http\Controllers\SendEmailController::class, 'index'])->name('send-email');
