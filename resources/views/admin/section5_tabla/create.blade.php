...
<div class="container w-75 p-4">
    <div class="card border border-dark">
        <div class="card-header bg-dark">
            <h5>{{config('app.nav_section5')}} / Nuevo elemento</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('section5_tabla.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="mb-5">
                    <label for="title" class="form-label">Elemento: </label>
                    <input type="text" name="elemento" class="form-control" value="">
                ...
                <div class="input-group">
                    <div class="mr-5 mb-3">
                        ...
                        <input type="text" name="u_m" class="form-control" value="">
                ...
                <div class="mb-3 mt-4">
                    ...
                    <textarea rows="5" class="w-100" type="text" name="descripcion" class="form-control"></textarea>
