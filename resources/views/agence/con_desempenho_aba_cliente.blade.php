    ...
    -->
                                        ...
                                        <form action="\con_desempenho_aba_cliente">
                                            <td nowrap valign="bottom" align="center"><input type="submit"
                                                    value="Por Cliente" name="act2" class="tab_current"> </td>
                                        </form>
                                        <td nowrap valign="bottom" align="center" class="cel_tab">&nbsp;&nbsp;</td>
                                    ...
                                    <tbody>
                                                    ...
                                                    <font color="black">
                                                        <form action="con_desem_cliente_rel.htm">
                                                            <input
                                                                ...
                                                                type="submit" value="Relat�rio" name="btSalvar22" />
                                                        </form>
                                                        <form action="con_desem_cliente_graf.htm"><input
                                                                ...
                                                                type="submit" value="Gr�fico" name="btSalvar222" />
                                                        </form>
                                                        <form action="con_desem_cliente_pizza.htm"><input
                                        ...
                                        <tr bgcolor="#fafafa">
                                            <td nowrap="nowrap" bgcolor="#efefef">
                                                <div align="right"><strong>Clientes</strong></div>
                                            </td>
                                            <td>
                                                <table align="center">
                                                    <tr>
                                                        <td><select multiple size="8" name="list1"
                                                                ...
                                                                <br />
                                                                <b>Warning</b>: in_array(): Wrong datatype for second
                                                                argument in
                                                                <b>D:\Inetpub\wwwroot\caol\classes\class_os.php</b> on
                                                                line <b>512</b><br />
                                                                <br />
                                                                <b>Warning</b>: in_array(): Wrong datatype for second
                                                                argument in
                                                                ...
                                                                <option value="7052">Anucc Associa��o dos Usuarios de
                                                                    Cart�o de Cr�dito</option>
                                                                <option value="7005">Archivum - Organiza��o e Guarda
                                                                ...
                                                                <option value="6981">Ateflor Assessoria Tecnica
                                                                    Florestal Ltda</option>
                                                                ...
                                                                <option value="36">Cl�nica Dr. Wilson Cantero
                                                                </option>
                                                                <option value="7053">CMA Consultoria, M�todos,
                                                                    Assessoria e Mercantil S</option>
                                                                <option value="7040">Compactor</option>
                                                                <option value="6993">Consultafrete.com</option>
                                                                <option value="7007">Controle Solu��es Compartilhadas
                                                                </option>
                                                                ...
                                                                <option value="7045">Est�dio Fotogr�fico Rodrigo
                                                                    Gimenes</option>
                                                                <option value="7025">Facundo Imobili�ria</option>
                                                                <option value="6994">FC2 Marketing Promocional e
                                                                    Eventos</option>
                                                                ...
                                                                <option value="12">Guttier Personnalit� fran�aise
                                                                </option>
                                                                <option value="6978">H2L equipamentos e sistemas
                                                                </option>
                                                                ...
                                                                <option value="7033">Informativa distribuidora e
                                                                    comunica��o</option>
                                                                ...
                                                                <option value="7020">marcus vinicius academia
                                                                </option>
                                                                <option value="7051">Maria e Maria</option>
                                                                <option value="39">Mark Trabalhos Tempor�rios
                                                                </option>
                                                                ...
                                                                <option value="7001">MMLink Representa��o Comercial
                                                                    Ltda.</option>
                                                                ...
                                                                <option value="7055">QUALITEC CONSULTORIA IMOBILIARIA
                                                                    LTDA</option>
                                                                <option value="62">QUICKNESS</option>
                                                                <option value="6723">R. MIRANDA FORMA��O PROFISSIONAL
                                                                </option>
                                                                <option value="47">RAIDHO</option>
                                                                <option value="6884">RECAST CONSULTORIA E MARKETING
                                                                    LTDA</option>
                                                                ...
                                                                <option value="55">S�O PAULO ALPARGATAS S.A
                                                                </option>
                                                                <option value="7039">Search RH</option>
                                                                <option value="6940">Secretaria de Seguran�a P�blica
                                                                </option>
                                                                <option value="6701">SERT�O</option>
                                                                <option value="43">Simpress Ind. Com. e Loca��o
                                                                </option>
                                                                <option value="7050">Sina Enxovais</option>
                                                                <option value="14">Sinal Ve�culos</option>
                                                                <option value="6970">SIQ Systems</option>
                                                                <option value="45">Souza Lima Seguran�a Patrimonial
                                                                </option>
                                                                <option value="6883">Spot Publicidade</option>
                                                                <option value="6992">Stampa Com�rcio de Alimentos
                                                                </option>
                                                                ...
                                                                <option value="48">VENICE VIAGENS E TURISMO
                                                                </option>
                                                                <option value="1">Vivo</option>
                                                                <option value="20">VOE GOL</option>
                                                                <option value="6939">WBC International Business
                                                                </option>
